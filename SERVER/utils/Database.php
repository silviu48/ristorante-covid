 ...
 * @uses PHP 7.0+ (scalar type declarations, return type declarations)
 * @uses PHP 5.4+ (short array syntax)
 *
 * To use the DB class, define DB_HOST, DB_USER, DB_PASSWD, and DB_NAME or see DB::getConnection().
 *
 * <code>
 * $row = DB::getRow($query);
 *
